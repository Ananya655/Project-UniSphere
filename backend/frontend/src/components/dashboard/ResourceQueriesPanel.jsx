      ...
      <div style={{ padding: '18px 20px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 15, fontWeight: 600, color: '#fff', marginBottom: 6 }}>{query.title}</div>
            <p style={{ fontSize: 13.5, color: '#A3A3BD', margin: '0 0 10px', lineHeight: 1.5 }}>{query.body}</p>
        ...
        >
          <span style={{ fontSize: 12.5, color: '#8C8CA8' }}>
      ...
      {expanded && (
        ...
        >
          {loadingDetail ? (
            ...
            <>
              {answers.length === 0 ? (
                <p style={{ fontSize: 13.5, color: '#8C8CA8', padding: '16px 0 8px', margin: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, paddingTop: 16 }}>
                  {visibleAnswers.map((answer) => (
                    ...
                    >
                      <p style={{ fontSize: 13.5, color: '#EDEDF4', margin: '0 0 8px', lineHeight: 1.5 }}>
                        {answer.body}
                      </p>
              ...
              {!isResolved && (
                <form onSubmit={handleSubmitAnswer} style={{ marginTop: 16 }}>
                  <label
                    ...
                    style={{ display: 'block', fontSize: 12.5, fontWeight: 600, color: '#A3A3BD', marginBottom: 6 }}
                  >
                    Write an answer
                  </label>
                  <textarea
              ...
              {error && (
                <p style={{ fontSize: 13, color: '#FF8F73', marginTop: 12, marginBottom: 0 }}>{error}</p>
              )}
            </>
          )}
        </div>
    ...
    <>
      ...
      {loading ? (
        ...
        >
          ...
          >
            <HelpCircle size={26} color="#A9BBFF" strokeWidth={1.6} />
          </div>
          <h2
            style={{
              fontFamily: "'Fraunces', serif",
          ...
          <p style={{ fontSize: 14, color: '#8C8CA8', maxWidth: 400, margin: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <MessageSquare size={15} color="#6B6B8A" />
