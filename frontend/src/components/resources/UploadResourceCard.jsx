...
const THEME = {
  ...
  borderSubtle: 'var(--dash-border-subtle)',
    ...
    >
      <div
        ...
        style={{
          ...
          border: `1px solid ${THEME.border}`,
          borderRadius: 18,
          boxShadow: '0 24px 64px rgba(183, 167, 169, 0.22)',
        }}
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 13.5, color: THEME.textMuted, margin: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label htmlFor="upload-title" style={labelStyle}>
                Title <span style={{ color: THEME.accentHover }}>*</span>
              </label>
              <input
                id="upload-title"
                value={form.title}
            ...
            <div>
              <label htmlFor="upload-description" style={labelStyle}>
                Description <span style={{ color: THEME.textMuted, fontWeight: 500 }}>(optional)</span>
              </label>
              <textarea
            ...
            <div>
              ...
              <input
                ...
                value={form.college}
                readOnly
                style={{ ...fieldStyle, color: THEME.textMuted, cursor: 'not-allowed' }}
              />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                <label htmlFor="upload-branch" style={labelStyle}>
                  Branch <span style={{ color: THEME.accentHover }}>*</span>
                </label>
                <input
                  id="upload-branch"
                  value={form.branch}
              ...
              <div>
                <label htmlFor="upload-semester" style={labelStyle}>
                  Semester <span style={{ color: THEME.accentHover }}>*</span>
                </label>
                <select
                  id="upload-semester"
                  value={form.semester}
            ...
            <div>
              <label htmlFor="upload-subject" style={labelStyle}>
                Subject <span style={{ color: THEME.accentHover }}>*</span>
              </label>
              <select
                id="upload-subject"
            ...
            {form.subjectId === OTHER_SUBJECT_VALUE && (
              <div>
                <label htmlFor="upload-custom-subject" style={labelStyle}>
                  Subject name <span style={{ color: THEME.accentHover }}>*</span>
                </label>
                <input
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                <label htmlFor="upload-type" style={labelStyle}>
                  Resource type <span style={{ color: THEME.accentHover }}>*</span>
                </label>
                <select
                  id="upload-type"
                  value={form.type}
              ...
              <div>
                <label htmlFor="upload-year" style={labelStyle}>
                  Year <span style={{ color: THEME.accentHover }}>*</span>
                </label>
                <select
                  id="upload-year"
                  value={form.year}
            ...
            <div>
              <label style={labelStyle}>
                PDF file <span style={{ color: THEME.accentHover }}>*</span>
              </label>
              <div
                onDragOver={(event) => {
                  event.preventDefault();
                ...
                style={{
                  border: `1.5px dashed ${dragOver ? THEME.accentHover : THEME.border}`,
                  borderRadius: 12,
                  padding: '28px 20px',
                  textAlign: 'center',
                  cursor: 'pointer',
                  background: dragOver ? THEME.borderSubtle : THEME.bg,
              ...
              >
                ...
                {file ? (
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                    <FileText size={22} color={THEME.accentHover} />
                    <div style={{ textAlign: 'left' }}>
                      <div style={{ fontSize: 14, fontWeight: 600, color: THEME.text }}>{file.name}</div>
                  ...
                  <>
                    <Upload size={24} color={THEME.accentHover} style={{ margin: '0 auto 10px' }} />
          ...
          {error && (
            <p
              style={{
                ...
                border: `1px solid rgba(178, 93, 82, 0.22)`,
                borderRadius: 8,
                padding: '10px 12px',
              }}
            >
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 9,
                border: 'none',
                background: submitting ? THEME.accentHover : THEME.accent,
                color: THEME.white,
                fontSize: 14,
                fontWeight: 700,
                fontFamily: "'Inter', sans-serif",
